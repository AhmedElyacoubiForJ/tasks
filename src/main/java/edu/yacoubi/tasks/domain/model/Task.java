package edu.yacoubi.tasks.domain.model;

import edu.yacoubi.tasks.domain.model.enums.TaskPriority;
import edu.yacoubi.tasks.domain.model.enums.TaskStatus;
import edu.yacoubi.tasks.domain.exceptions.DomainRuleViolationException;
import edu.yacoubi.tasks.domain.exceptions.DomainValidationException;
